    ...
    <div className="flex flex-col items-center mt-10">
      <div className='flex justify-between w-full max-w-[80vw]'>
        <div className='flex flex-col w-5/12'>
          ...
          <div className="bg-black w-full max-w-[80vw] h-full max-h-[70vh] overflow-y-scroll p-4 border-2 border-[#FB6666] rounded-lg">
            <p className="text-white poppins-regular whitespace-pre-wrap text-sm">{text}</p>
          </div>
        </div>
        <div className='flex flex-col w-5/12'>
          <h1 className="text-2xl font-semibold mb-4">Highlighted Text</h1>
          <div className="bg-black w-full max-w-[80vw] h-full max-h-[70vh] overflow-y-scroll p-4 border-2 border-[#FB6666] rounded-lg">
            <p className="text-white poppins-thin whitespace-pre-wrap text-sm">{getHighlightedText(text, highlights)}</p>
          </div>
        </div>
      </div>
      <button 
